...
void fused_attn_arbitrary_seqlen_fwd_impl(
    ...
    int64_t window_size_left, int64_t window_size_right, bool bottom_right_diagonal, void *devPtrQ, void *devPtrK,
...
void fused_attn_arbitrary_seqlen_bwd_impl(
    ...
    NVTE_Bias_Type bias_type, NVTE_Mask_Type mask_type, NVTE_Softmax_Type softmax_type,
    int64_t window_size_left, int64_t window_size_right, bool bottom_right_diagonal, bool deterministic, void *devPtrQ,
...
void fused_attn_arbitrary_seqlen_bwd(
    ...
    NVTE_Bias_Type bias_type, NVTE_Mask_Type mask_type, NVTE_Softmax_Type softmax_type,
    int64_t window_size_left, int64_t window_size_right, bool bottom_right_diagonal, bool deterministic, const Tensor *input_Q,
  ...
  fused_attn_arbitrary_seqlen_bwd_impl(
      ...
      bottom_right_diagonal, deterministic, devPtrQ, devPtrK, devPtrV, devPtrO,
      devPtrSoftmaxStats, devPtrBias, devPtrSoftmaxOffset, devPtrdQ, devPtrdK, devPtrdV,
