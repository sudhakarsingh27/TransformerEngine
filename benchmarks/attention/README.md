...
| `fp8_dpa` | `False` | Run dot-product attention in FP8; required for an FP8 DPA benchmark |
| `fp8_mha` | `False` | Run the full attention input/output path in FP8 |
| `fp8_bwd` | `True` | Enable FP8 backward when the selected FP8 mode supports it |
| `scaling_mode` | `delayed` | FP8 recipe: `delayed`, `current`, or `mxfp8` |
